  ...
  return (
    <div className="flex h-full flex-col" dir="rtl">
      ...
      <main className="flex-1 px-5 py-5 space-y-6">
        ...
        <Link
          to="/first-scan"
          className="flex items-center gap-3 rounded-xl bg-card border border-border p-3 hover:bg-warm/40"
        >
          <span className="grid h-9 w-9 place-items-center rounded-full bg-orange/10 text-orange text-base">
            📖
          </span>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-bold flex items-center gap-2">
              <BookOpen className="h-4 w-4 text-orange" /> آخر المسوحات
            </h3>
            <Link to="/collection" className="text-xs text-orange font-semibold">
              عرض الكل
            </Link>
          </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-3">
            <h3 className="font-bold flex items-center gap-2">
              <TrendingUp className="h-4 w-4 text-orange" /> رائج في السوق
            </h3>
            <Link to="/market" className="text-xs text-orange font-semibold">
              السوق
            </Link>
          </div>
