...
function CollectionPage() {
  ...
  const doExport = (fmt: "csv" | "json") => {
    ...
    if (fmt === "csv")
      downloadFile(`tissint-collection-${stamp}.csv`, exportCollectionCSV(collection), "text/csv");
    else
      downloadFile(
        `tissint-collection-${stamp}.json`,
  ...
  return (
    <div className="flex h-full flex-col" dir="rtl">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="rounded-full bg-white/10 text-warm text-xs font-bold px-3 py-1.5 flex items-center gap-1"
            >
      ...
      {exportOpen && (
        ...
        >
          <div
            className="w-full bg-card rounded-t-3xl p-5 space-y-3"
          ...
          >
            ...
            <button
              ...
              className="w-full rounded-xl bg-card border-2 p-3 flex items-center gap-3 text-right"
            >
