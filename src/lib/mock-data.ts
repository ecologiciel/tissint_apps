...
export const MOCK_LISTINGS: Listing[] = [
  ...
  },
  {
    id: "lst-003",
    title: "Chondrite L6",
    classification: "Chondrite ordinaire L6",
    weightG: 312,
    priceDh: 6800,
    priceMode: "fixed",
    region: "زاكورة",
    sellerName: "يوسف بناصر",
  ...
  {
    id: "lst-004",
    title: "Shergottite (Martian)",
    classification: "Shergottite — أصل مريخي",
    weightG: 12,
    priceDh: 38000,
    priceMode: "auction",
    region: "الداخلة",
    sellerName: "د. كريم الفاسي",
    sellerVerified: true,
    score: 92,
    status: "approved",
    imageSeed: "lst-004",
  ...
  {
    id: "lst-005",
    title: "Lunaire — شظية قمرية",
    classification: "Lunar meteorite",
    weightG: 3,
    priceDh: 24000,
    priceMode: "fixed",
    region: "أكادير",
    sellerName: "سعاد البوعنانية",
    sellerVerified: true,
    score: 90,
    status: "approved",
    imageSeed: "lst-005",
...
export const MOCK_CONVERSATIONS: Conversation[] = [
  {
    ...
    listingImageSeed: "lst-001",
    peerName: "محمد العلوي",
    peerVerified: true,
    lastMessage: "نعم، السعر قابل للتفاوض قليلاً.",
    lastAt: "2026-05-27T14:20:00Z",
    unread: 2,
  },
  {
    id: "th-002",
    ...
    listingImageSeed: "lst-002",
    peerName: "ورشة الأطلس",
    peerVerified: true,
    lastMessage: "يمكنني إرسال صور إضافية اليوم.",
    lastAt: "2026-05-26T10:05:00Z",
    unread: 0,
  },
  {
    id: "th-003",
    listingId: "lst-004",
    listingTitle: "Shergottite (Martian)",
    listingImageSeed: "lst-004",
    peerName: "د. كريم الفاسي",
    peerVerified: true,
    lastMessage: "شكراً، سأراجع الشهادة وأعود إليك.",
    lastAt: "2026-05-24T09:40:00Z",
    unread: 0,
  },
];
...
export const MOCK_MESSAGES: ChatMessage[] = [
  ...
  },
  {
    ...
    threadId: "th-001",
    fromMe: false,
    text: "نعم، السعر قابل للتفاوض قليلاً.",
  ...
  },
  {
    ...
    threadId: "th-001",
    fromMe: false,
    text: "هل تريد المعاينة في طاطا؟",
    createdAt: "2026-05-27T14:21:00Z",
    read: false,
  },

  {
    ...
    createdAt: "2026-05-26T09:50:00Z",
    read: true,
  },
  {
    id: "m7",
...

  {
    ...
    threadId: "th-003",
    fromMe: true,
    text: "لدي اهتمام بالقطعة المريخية.",
  ...
  },
  {
    ...
    threadId: "th-003",
    fromMe: false,
    text: "شكراً، سأراجع الشهادة وأعود إليك.",
...
export const MOCK_NOTIFICATIONS: AppNotification[] = [
  {
    ...
    createdAt: "2026-05-27T14:20:00Z",
    read: false,
    linkTo: "/messages/$threadId",
    linkParams: { threadId: "th-001" },
  },
  {
    id: "n2",
    ...
    read: false,
    linkTo: "/market/my-listings",
  },
  {
    id: "n3",
    kind: "scan_done",
    title: "اكتمل التحليل",
    body: "النتيجة: Chondrite H5 — 87/100.",
    createdAt: "2026-05-25T11:12:00Z",
    read: true,
    linkTo: "/collection",
  },
  {
  ...
  },
  {
    ...
    kind: "system",
    title: "صيانة قصيرة",
    body: "تم تحسين أداء المسح بنسبة 30٪.",
